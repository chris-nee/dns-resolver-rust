        ...
        match udp_socket.recv_from(&mut buf) {
            Ok((size, source)) => {
                ...
                let header = DNSHeader::new(
                    ...
                    (_received_header[2] as u8 & ((1 as u8) << 7)) >> 7,
                    (_received_header[2] as u8 & ((15 as u8) << 3)) >> 3,
                    (_received_header[2] as u8 & ((1 as u8) << 2)) >> 2,
                    (_received_header[2] as u8 & ((1 as u8) << 1)) >> 1,
                    _received_header[2] as u8 & (1 as u8),
                    (_received_header[3] as u8 & ((1 as u8) << 7)) >> 7,
                    (_received_header[3] as u8 & ((7 as u8) << 4)) >> 4,
